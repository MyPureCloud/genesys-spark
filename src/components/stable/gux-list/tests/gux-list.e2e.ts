...
const axeExclusions = [
  {
    ...
    target: 'gux-list-item[value="test2"],gux-text-highlight > span',
    exclusionReason:
...
const html = `<gux-list>
  <gux-list-item value="test1" text="first"></gux-list-item>
  <gux-list-divider></gux-list-divider>
  <gux-list-item value="test2" text="second" disabled></gux-list-item>
  <gux-list-item value="test3" text="third"></gux-list-item>
</gux-list>`;
