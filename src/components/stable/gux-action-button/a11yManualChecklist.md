...
**Last Updated:** Fri Dec 17 2021 16:15:43 GMT-0500 (Eastern Standard Time)
| Pass | WCAG Success Criterion | Notes |
| --- | --- | --- |
| ❌ | [2.1.1 Keyboard](https://www.w3.org/WAI/WCAG21/Understanding/keyboard.html) | COMUI-809 Keyboard navigation should not affect scrolling of page, COMUI-513 dropdown patterns should be standardized |
...
| ❌ | [4.1.2: Name, Role, Value](https://www.w3.org/WAI/WCAG21/Understanding/name-role-value.html) | COMUI-810 list items need interactive semantics |
