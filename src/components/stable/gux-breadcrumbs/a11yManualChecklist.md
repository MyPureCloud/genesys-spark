...
**Last Updated:** Tue Dec 21 2021 14:42:14 GMT-0500 (Eastern Standard Time)
...
| ❌ | [2.4.7 Focus Visible](https://www.w3.org/WAI/WCAG21/Understanding/focus-visible.html) | COMUI-818 should not rely on default browser focus style for breadcrumb links |
...
| ❌ | [4.1.2: Name, Role, Value](https://www.w3.org/WAI/WCAG21/Understanding/name-role-value.html) | COMUI-818 Breadcrumbs structure should be an ordered list. Current breadcrumb item should have an attribute of 'aria-current=page' |
