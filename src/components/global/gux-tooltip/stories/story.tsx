      ...
      html`
        ...
        >
          ...
          <div style="display:flex;flex-grow:1;flex-direction:column">
            <div
              id="scroll"
              style="margin-top:150px;height:300px;overflow-y:scroll;overflow-x:hidden;border:2px dashed grey"
            >
              <div
                id="scroll2"
                style="margin:100px -2px;height:150px;overflow-y:scroll;border:2px dashed grey"
              >
        ...
        <gux-tooltip
          ...
          text=${text(
            'text',
            'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quo molestias facere ab deserunt dolores, recusandae non consequuntur quia perferendis officia vero maiores voluptatem temporibus veritatis, fugit nihil, id nobis at.'
          )}
