...
export class GenesysRating {
   ...
   * The rating
   */
  @Prop({mutable: true, reflectToAttr: true}) rating: number = 0;
   ...
   */
  @Prop() svgPoints: string = "12,5 14,10 19,10 15.133,13.988 17,19 12,16 7,19 9,14 5,10 10,10 ";

  /**
   * The rating items, set once the component is loaded
   */
  @State() ratingItems: any[] = [];
   ...
   */
  @Prop() svgViewBox: string = "0 0 24 24";
  ...
  onKeyDown (event: KeyboardEvent) {
    ...
    const regxp = new RegExp(`${KeyCode.Right}|${KeyCode.Up}|${KeyCode.Left}|${KeyCode.Down}|${KeyCode.End}|${KeyCode.Home}`);
    ...
    const matches = this.root.querySelectorAll('.genesys-rating > div') as any as HTMLDivElement[];
    ...
    return (
      <div class='genesys-rating' 
        ...
        {this.ratingItems.map( (ratingItem, i) =>
          <div 
              role="radio"
              aria-checked={(this.rating - 1) === i ? 'true' : (this.rating - 1) === i - 0.5 ? 'mixed' : 'false'}
                ...
                <g
                  ...
                  stroke-width="1">
                    <polygon
                      ...
                      stroke-width="1"
                      class={"genesys-rating-item-shape-default genesys-rating-item-shape-fill-percent-" + ratingItem.percent}
