...
export class GuxDropdownLegacy {
  ...
  _optionFocusedHandler(e: FocusEvent) {
    whenEventIsFrom('gux-option-legacy', e, elem => {
      const option = elem as HTMLGuxOptionLegacyElement;
      this.forcedGhostValue =
  ...
  private getSelectionOptions(): HTMLGuxOptionLegacyElement[] {
    const result: HTMLGuxOptionLegacyElement[] = [];
    ...
    childrenElements.forEach(child => {
      if (child.matches('gux-option-legacy')) {
        result.push(child as HTMLGuxOptionLegacyElement);
      }
    });
  ...
  private getFocusIndex(
    selectionOptions: HTMLGuxOptionLegacyElement[]
  ): number {
