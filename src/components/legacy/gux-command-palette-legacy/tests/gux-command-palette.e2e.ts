...
describe('gux-command-palette', () => {
  ...
  it('shows the palette when opened', async () => {
    ...
    await page.setContent(`
    <gux-command-palette-legacy lang="en">
      <gux-command-action text="test"></gux-command-action>
    </gux-command-palette-legacy>`);

    await page.waitForChanges();
    let component = await page.find('gux-command-palette-legacy');

    await component.callMethod('open');

    await page.waitForChanges();
    component = await page.find('gux-command-palette-legacy');
  ...
  it('shows recent items if available', async () => {
    ...
    const component = await page.find('gux-command-palette-legacy');
    await component.callMethod('open');
    await page.waitForChanges();
  ...
  describe('keyboard navigation', () => {
    ...
    beforeEach(async () => {
      ...
      commandPallete = await page.find('gux-command-palette-legacy');
