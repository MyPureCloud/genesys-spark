...
export const CDN_URL = 'https://dhqbrvplips7x.cloudfront.net/spark-components/3.81.6-156/';
...
function getDomain() {
    ...
    const matchedDomain = DOMAIN_LIST.find(regionDomain => domain.endsWith(regionDomain));
