...
import { o as onInputDisabledStateChange } from './on-input-disabled-state-change-3ea76372.js';
import { t as trackComponent } from './usage-55de2afe.js';
import { g as getSearchOption } from './gux-listbox.service-534dc33f.js';
...
const GuxDropdownMulti = class {
  constructor(hostRef) {
    ...
    this.guxcreateoption = createEvent(this, "guxcreateoption", 7);
...
export { GuxDropdownMulti as gux_dropdown_multi_beta };
