...
const GuxColorSelect = class {
  ...
  render() {
    return [
      index.h("div", { hidden: true }, index.h("slot", { name: "input" })),
      index.h("div", null, index.h("div", { class: "gux-input-color-matrix" }, this.renderDefaultTiles()))
    ];
  }
  renderDefaultTiles() {
    return defaultColors.map((color, index$1) => (index.h("gux-input-color-option", { key: `${color}-${index$1}`, value: color, active: this.color.toLowerCase() === color.toLowerCase() })));
  }
...
exports.gux_color_select = GuxColorSelect;
exports.gux_input_color_option = GuxInputColorOption;
