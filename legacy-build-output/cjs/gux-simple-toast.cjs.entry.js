...
const GuxSimpleToast = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: `gux-icon gux-${this.accent}` }, index.h("slot", { name: "icon" })), index.h("gux-truncate-beta", { class: "gux-message", "max-lines": 2 }, index.h("slot", { name: "message" })), index.h("gux-dismiss-button", { class: "gux-dismiss", position: "inherit", onClick: this.onDismissClickHandler.bind(this) })));
  }
...
exports.gux_simple_toast = GuxSimpleToast;
