...
const GuxAccordionLegacy = class {
  ...
  render() {
    return (index.h("div", { class: "gux-accordion" }, this.sections.map(section => (index.h("section", { class: "gux-section", onKeyDown: event => onKeyboardNavigation(event, section.slotName, this.sections), ref: el => (section.ref = el) }, index.h("div", { "aria-role": "heading", "aria-level": this.headingLevel, class: "gux-header" }, index.h("button", { class: "gux-header-button", type: "button", onClick: () => this.toggle(section.slotName) }, index.h("div", { class: "gux-text" }, section.slotName), this.arrowPosition === 'beside-text' ? null : (index.h("div", { class: "gux-spacer" })), index.h("div", { class: "gux-toggle-arrow" }, index.h("gux-icon", { decorative: true, "icon-name": "chevron-small-down" })))), index.h("div", { class: "gux-content" }, index.h("slot", { name: section.slotName })))))));
  }
  get root() { return index.getElement(this); }
};
GuxAccordionLegacy.style = guxAccordionCss;

exports.gux_accordion_legacy = GuxAccordionLegacy;
