...
const GuxActionButtonLegacy = class {
  ...
  render() {
    return (index.h("div", { class: "gux-action-button-container" }, index.h("gux-popup", { expanded: this.isOpen, disabled: this.disabled }, index.h("div", { slot: "target", class: "gux-action-button-container" }, index.h("gux-button-slot-beta", { class: "gux-action-button", accent: this.accent }, index.h("button", { type: this.type, disabled: this.disabled, onClick: () => this.onActionClick() }, this.text)), index.h("gux-button-slot-beta", { class: "gux-dropdown-button", accent: this.accent }, index.h("button", { type: "button", disabled: this.disabled, ref: el => (this.dropdownButton = el), onClick: () => this.toggle(), "aria-haspopup": "true", "aria-expanded": this.isOpen.toString(), "aria-label": this.i18n('actionButtonDropdown', {
        buttonTitle: this.text
      }) }, index.h("gux-icon", { decorative: true, "icon-name": "chevron-small-down" })))), index.h("gux-action-list-legacy", { slot: "popup", ref: el => (this.actionListElement = el) }, index.h("slot", null)))));
  }
...
exports.gux_action_button_legacy = GuxActionButtonLegacy;
