...
const GuxInputCheckbox = class {
  ...
  render() {
    return (index.h("div", { class: "gux-input-checkbox-container" }, index.h("slot", { name: "input" }), index.h("slot", { name: "label" })));
  }
};
...
const GuxInputColor = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.requiredId = randomHtmlId.randomHTMLId('gux-input-color-required');
  ...
  async componentWillLoad() {
    this.i18n = await index$1.buildI18nForComponent(this.root, colorInputResources);
  ...
  render() {
    return (index.h("section", null, index.h("span", { class: "gux-hidden", id: this.requiredId }, this.i18n('required')), index.h("button", { "aria-describedby": `${this.guxLabelDescribedby} ${this.guxRequired ? this.requiredId : ''} ${this.guxErrorDescribedby}`, "aria-expanded": this.opened ? 'true' : 'false', type: "button", class: {
        'gux-input-color-main-element': true,
        'gux-opened': this.opened
      }, disabled: this.disabled, onClick: this.clickHandler.bind(this) }, index.h("div", { class: "gux-input-color-selected-color", style: { background: this.color } }), index.h("div", { class: "gux-input-color-color-name" }, this.color), index.h("gux-icon", { decorative: true, "icon-name": "chevron-small-down" })), index.h("gux-color-select", { class: {
        'gux-input-color-color-select': true,
        'gux-opened': this.opened
      } }, index.h("slot", { name: "input", slot: "input" }))));
  }
  setOpened(opened) {
...
const GuxInputNumber = class {
  ...
  simulateNativeInputAndChangeEvents() {
    simulateNativeEvent.simulateNativeEvent(this.input, 'input');
    simulateNativeEvent.simulateNativeEvent(this.input, 'change');
  }
  stepUp() {
    if (this.input.value === '') {
      setInputValue.setInputValue(this.input, this.input.min || '0', false);
    }
    else {
      this.input.stepUp();
  ...
  renderStepButtons() {
    return (index.h("div", { class: "gux-step-buttons-container" }, index.h("button", { class: "gux-step-button", tabIndex: -1, type: "button", title: this.getI18nValue('increment'), disabled: this.disabled, onClick: () => this.stepUp() }, index.h("gux-icon", { "icon-name": "chevron-small-up", decorative: true })), index.h("button", { class: "gux-step-button", tabIndex: -1, type: "button", title: this.getI18nValue('decrement'), disabled: this.disabled, onClick: () => this.stepDown() }, index.h("gux-icon", { "icon-name": "chevron-small-down", decorative: true }))));
  }
  async componentWillLoad() {
  ...
  render() {
    return (index.h("div", { class: {
      ...
      } }, index.h("div", { class: "gux-input-container" }, index.h("slot", { name: "input" }), this.renderClearButton()), this.renderStepButtons()));
  }
  get root() { return index.getElement(this); }
};
...
const GuxInputRadio = class {
  ...
  render() {
    return (index.h("div", { class: "gux-input-radio-container" }, index.h("slot", { name: "input" }), index.h("slot", { name: "label" })));
  }
};
...
const GuxInputRange = class {
  ...
  render() {
    return (index.h("div", { class: {
      ...
      } }, index.h("div", { class: "gux-track" }, index.h("div", { class: "gux-progress", ref: el => (this.progressElement = el) })), index.h("slot", { name: "input" }), index.h("div", { class: {
...
const GuxInputSelect = class {
  ...
  render() {
    return (index.h("div", { class: {
        ...
        'gux-disabled': this.disabled
      } }, index.h("slot", { name: "input" }), index.h("gux-icon", { decorative: true, iconName: "ic-dropdown-arrow" })));
  }
  get root() { return index.getElement(this); }
};
...
const GuxInputTextArea = class {
  ...
  render() {
    return (index.h("div", { ref: el => (this.containerElement = el), class: `gux-resize-${this.resize}` }, index.h("slot", { name: "input" })));
  }
  get root() { return index.getElement(this); }
};
GuxInputTextArea.style = guxInputTextareaCss;

exports.gux_input_checkbox = GuxInputCheckbox;
exports.gux_input_color = GuxInputColor;
exports.gux_input_number = GuxInputNumber;
exports.gux_input_radio = GuxInputRadio;
exports.gux_input_range = GuxInputRange;
exports.gux_input_select = GuxInputSelect;
exports.gux_input_textarea = GuxInputTextArea;
