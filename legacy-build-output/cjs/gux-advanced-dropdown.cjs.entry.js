...
const GuxAdvancedDropdown = class {
  ...
  render() {
    return (index.h("gux-popup-beta", { expanded: this.opened, disabled: this.disabled }, index.h("div", { slot: "target", class: "gux-select-field", onMouseDown: () => this.inputMouseDown() }, index.h("a", { ref: el => (this.inputBox = el), class: "gux-select-input", "aria-labelledby": this.srLabelledby, tabindex: "0", onKeyDown: e => this.inputKeyDown(e) }, this.placeholder && !this.value && (index.h("span", { class: "gux-select-placeholder", title: this.placeholder }, this.placeholder)), this.value && (index.h("span", { class: "gux-select-value", title: this.value }, this.value))), index.h("div", { class: "gux-icon-wrapper" }, index.h("gux-icon", { decorative: true, "icon-name": "chevron-small-down" }))), index.h("div", { slot: "popup", class: "gux-advanced-dropdown-menu" }, index.h("div", { class: "gux-dropdown-menu-container" }, index.h("gux-form-field-search", { "label-position": "screenreader" }, index.h("label", { slot: "label" }, this.i18n('searchAria')), index.h("input", { slot: "input", type: "search", onInput: (event) => {
