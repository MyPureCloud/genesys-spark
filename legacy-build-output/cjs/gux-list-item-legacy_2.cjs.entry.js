...
const GuxListItemLegacy = class {
  ...
  render() {
    return (index.h(index.Host, { role: "listitem" }, index.h("span", { class: "gux-list-item" }, this.text && (index.h("gux-text-highlight", { class: "gux-text", text: this.text, strategy: this.strategy })), index.h("slot", null))));
  }
  onItemClicked() {
    this.emitPress();
  }
...
const GuxListLegacy = class {
  ...
  render() {
    this.performHighlight(this.highlight);
    this.updateTabIndexes();
    return (index.h("div", { class: "gux-list-items-container", role: "list", tabindex: 0, onKeyDown: e => this.onKeyDown(e) }, index.h("slot", null)));
  }
  onKeyDown(event) {
...
exports.gux_list_item_legacy = GuxListItemLegacy;
exports.gux_list_legacy = GuxListLegacy;
