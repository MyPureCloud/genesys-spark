...
const GuxDropdownLegacy = class {
  ...
  _optionFocusedHandler(e) {
    whenEventIsFrom.whenEventIsFrom('gux-option-legacy', e, elem => {
      const option = elem;
      this.forcedGhostValue =
  ...
  render() {
    return (index.h("div", { class: `gux-dropdown gux-${this.mode} ${this.disabled ? 'gux-disabled' : ''} ${this.opened ? 'gux-active' : ''}`, onKeyDown: e => this.onKeyDown(e) }, index.h("div", { class: "gux-select-field" }, index.h("span", { class: `gux-filter-suggestion ${this.opened ? 'gux-active' : ''}`, "aria-hidden": "true" }, index.h("span", { class: "gux-filter-text" }, this.value), index.h("span", { class: "gux-filter-typeahead" }, this.getSuggestionText(this.value))), index.h("gux-input-text-like", null, index.h("input", { placeholder: this.placeholder, slot: "input", value: this.value, "aria-labelledby": this.srLabeledBy, disabled: this.disabled, ref: ref => (this.textFieldElement = ref), onMouseDown: () => {
        this._clickHandler();
      }, onFocus: () => {
        this._focusHandler();
      }, onBlur: () => {
      ...
      } })), index.h("button", { class: "gux-dropdown-indicator", "aria-hidden": "true", tabindex: "-1", type: "button" }, index.h("gux-icon", { decorative: true, "icon-name": "chevron-small-down" }))), index.h("div", { class: `gux-options ${this.opened ? 'gux-opened' : ''}`, onClick: this.optionSelectedHandler.bind(this), onFocusin: this._optionFocusedHandler.bind(this), onKeyDown: this.optionKeyDownHandler.bind(this) }, index.h("slot", null))));
  }
...
exports.gux_dropdown_legacy = GuxDropdownLegacy;
