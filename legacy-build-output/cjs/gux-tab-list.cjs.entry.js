...
const GuxTabList = class {
  ...
  async componentWillLoad() {
    this.setTabTriggers();
    this.i18n = await index$1.buildI18nForComponent(this.root, tabsResources, 'gux-tabs');
  }
  componentDidLoad() {
  ...
  render() {
    return (index.h("div", { class: "gux-tab-container" }, this.hasHorizontalScrollbar
      ? this.renderScrollButton('scrollLeft')
      : this.renderScrollButton('scrollUp'), index.h("div", { role: "tablist", class: "gux-scrollable-section", "aria-owns": this.triggerIds }, index.h("slot", null)), this.hasHorizontalScrollbar
      ? this.renderScrollButton('scrollRight')
      : this.renderScrollButton('scrollDown')));
  }
  renderScrollButton(direction) {
    return (index.h("div", { class: "gux-scroll-button-container" }, this.hasHorizontalScrollbar || this.hasVerticalScrollbar ? (index.h("button", { disabled: this.getButtonDisabled(direction), tabindex: "-1", title: this.i18n(direction), "aria-label": this.i18n(direction), class: "gux-scroll-button", onClick: () => this.getScrollDirection(direction) }, index.h("gux-icon", { "icon-name": this.getChevronIconName(direction), decorative: true }))) : null));
  }
...
exports.gux_tab_list = GuxTabList;
