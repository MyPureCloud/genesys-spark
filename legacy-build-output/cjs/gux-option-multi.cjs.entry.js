...
const GuxOptionMulti = class {
  ...
  render() {
    return (index.h(index.Host, { role: "option", class: {
      ...
      }, "aria-selected": this.selected.toString(), "aria-disabled": this.disabled.toString() }, index.h("div", { "gux-slot-container": true, class: "gux-option" }, index.h("slot", null)), this.renderCustomOptionInstructions()));
  }
