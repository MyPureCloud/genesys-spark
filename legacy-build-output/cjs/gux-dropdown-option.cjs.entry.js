...
const GuxDropdownOption = class {
  ...
  __stencil_render() {
    return (index.h("div", { class: "gux-dropdown-option", title: this.text }, this.textWithHighlights()));
  }
  textWithHighlights() {
    ...
    return (index.h("span", null, preface, index.h("strong", null, actualHighlight), suffix));
  }
  onItemClicked() {
    this.selected = true;
    this.selectedChanged.emit(this.value);
...
exports.gux_dropdown_option = GuxDropdownOption;
