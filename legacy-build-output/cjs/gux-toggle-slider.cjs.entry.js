...
const GuxToggleSlider = class {
  ...
  render() {
    return (index.h("div", { class: {
      ...
      }, role: "checkbox", "aria-checked": this.checked.toString(), "aria-disabled": this.disabled.toString(), tabindex: this.disabled ? '' : '0', ref: el => (this.checkboxElement = el) }, index.h("div", { class: "gux-slider" }, index.h("div", { class: "gux-switch" }, index.h("gux-icon", { "icon-name": "checkmark", decorative: true })))));
  }
};
GuxToggleSlider.style = guxToggleSliderCss;

exports.gux_toggle_slider = GuxToggleSlider;
