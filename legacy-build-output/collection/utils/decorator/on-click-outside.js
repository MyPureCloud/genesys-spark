...
export function OnClickOutside(opt = OnClickOutsideOptionsDefaults) {
...
export function registerOnClickOutside(component, element, callback, opt = OnClickOutsideOptionsDefaults) {
...
export function removeOnClickOutside(component, element, callback, opt = OnClickOutsideOptionsDefaults) {
  getTriggerEvents(opt).forEach(triggerEvent => {
