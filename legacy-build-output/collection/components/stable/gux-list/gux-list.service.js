...
export function focusMove(root, validFocusableItems, delta) {
...
export function first(root, validFocusableItems) {
  focusIndex(root, validFocusableItems, 0);
}
export function last(root, validFocusableItems) {
  focusIndex(root, validFocusableItems, getLastChildIndex(root, validFocusableItems));
}
export function next(root, validFocusableItems) {
  focusMove(root, validFocusableItems, 1);
}
export function previous(root, validFocusableItems) {
  focusMove(root, validFocusableItems, -1);
}
export function byId(root, validFocusableItems, id) {
...
export function byClosestId(root, validFocusableItems, id) {
