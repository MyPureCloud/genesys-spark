...
| Name                               | Description |
| ---------------------------------- | ----------- |
| `--gse-ui-tag-background-accent1`  |             |
| `--gse-ui-tag-background-accent10` |             |
| `--gse-ui-tag-background-accent2`  |             |
| `--gse-ui-tag-background-accent3`  |             |
| `--gse-ui-tag-background-accent4`  |             |
| `--gse-ui-tag-background-accent5`  |             |
| `--gse-ui-tag-background-accent6`  |             |
| `--gse-ui-tag-background-accent7`  |             |
| `--gse-ui-tag-background-accent8`  |             |
| `--gse-ui-tag-background-accent9`  |             |
| `--gse-ui-tag-background-default`  |             |
| `--gse-ui-tag-foreground-accent1`  |             |
| `--gse-ui-tag-foreground-accent10` |             |
| `--gse-ui-tag-foreground-accent2`  |             |
| `--gse-ui-tag-foreground-accent3`  |             |
| `--gse-ui-tag-foreground-accent4`  |             |
| `--gse-ui-tag-foreground-accent5`  |             |
| `--gse-ui-tag-foreground-accent6`  |             |
| `--gse-ui-tag-foreground-accent7`  |             |
| `--gse-ui-tag-foreground-accent8`  |             |
| `--gse-ui-tag-foreground-accent9`  |             |
| `--gse-ui-tag-foreground-default`  |             |
| `--gse-ui-tag-label-font-family`   |             |
| `--gse-ui-tag-label-font-size`     |             |
| `--gse-ui-tag-label-font-weight`   |             |
| `--gse-ui-tag-label-line-height`   |             |
