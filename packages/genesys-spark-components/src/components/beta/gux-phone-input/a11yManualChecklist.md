# gux-phone-input manual accessibility testing status

**Last Updated:** 2025-02-25T14:59:44.377Z
| Pass | WCAG Success Criterion | Notes |
| --- | --- | --- |
| ❌ | [1.1.1 Non-text Content](https://www.w3.org/WAI/WCAG22/Understanding/non-text-content.html) | [COMUI-3512](https://inindca.atlassian.net/browse/COMUI-3512) region dropdown does have text option for selected region when closed |
