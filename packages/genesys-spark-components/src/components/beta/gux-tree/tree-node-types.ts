 ...
 */
const treeNodeTypes = ['gux-leaf', 'gux-branch'] as const;
 ...
 */
export type ValidNodeTag = (typeof treeNodeTypes)[number];

/**
 * Useful CSS selector generated from the list of option tags.
 */
export const optionTagSelector: string = treeNodeTypes.join(',');
