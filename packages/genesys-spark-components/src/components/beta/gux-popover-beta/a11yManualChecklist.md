# gux-popover-beta manual accessibility testing status

**Last Updated:** 2025-02-19T21:55:10.816Z
| Pass | WCAG Success Criterion | Notes |
| --- | --- | --- |
| ✅ | [1.1.1 Non-text Content](https://www.w3.org/WAI/WCAG22/Understanding/non-text-content.html) | - |
| ❌ | [2.1.1 Keyboard](https://www.w3.org/WAI/WCAG22/Understanding/keyboard.html) | Popover does not currently open with keyboard (COMUI-3500) |
| ✅ | [2.1.2 No Keyboard Trap](https://www.w3.org/WAI/WCAG22/Understanding/no-keyboard-trap.html) | - |
| ❌ | [2.4.3 Focus Order](https://www.w3.org/WAI/WCAG22/Understanding/focus-order.html) | Keyboard focus with tabs does not focus in the right order. Hitting tab key will move focus to previous button instead of the next button in the popover. Also, popover doesn't receive focus on open (COMUI-3500) |
