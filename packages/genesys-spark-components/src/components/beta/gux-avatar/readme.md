...
| `presence`          | `presence`      | Shows presence such as away or available. Must be combined with badge or ring props to take effect.                                                                    | `"available" \| "away" \| "break" \| "busy" \| "idle" \| "meal" \| "meeting" \| "offline" \| "on-queue" \| "out-of-office" \| "training"` | `'available'` |
