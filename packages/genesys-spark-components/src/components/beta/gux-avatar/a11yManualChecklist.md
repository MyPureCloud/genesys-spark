# gux-avatar manual accessibility testing status

**Last Updated:** 2024-05-29T11:26:05.062Z
| Pass | WCAG Success Criterion | Notes |
| --- | --- | --- |
| ✅ | [2.1.1 Keyboard](https://www.w3.org/WAI/WCAG21/Understanding/keyboard.html) | Use gux-avatar-focusable and button/a wrapper to make it focusable by keyboard |
...
| ✅ | [2.4.7 Focus Visible](https://www.w3.org/WAI/WCAG21/Understanding/focus-visible.html) | Use gux-avatar-focusable and button/a wrapper to make it focusable by keyboard |
