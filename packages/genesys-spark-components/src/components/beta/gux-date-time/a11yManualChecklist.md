# gux-date-time manual accessibility testing status

**Last Updated:** 2025-02-18T11:34:14.043Z
...
| ❌ | [4.1.2: Name, Role, Value](https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html) | [COMUI-3495](https://inindca.atlassian.net/browse/COMUI-3495) Investigate if the time html element should be used |
