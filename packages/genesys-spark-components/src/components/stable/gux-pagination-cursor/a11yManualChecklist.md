...
| ❌ | [4.1.2: Name, Role, Value](https://www.w3.org/WAI/WCAG21/Understanding/name-role-value.html) | COMUI-799 the 'next' and 'previous' buttons should convey which content it is associated with |
