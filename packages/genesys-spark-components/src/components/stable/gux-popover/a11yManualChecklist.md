# gux-popover manual accessibility testing status
**Last Updated:** Wed Dec 15 2021 15:43:02 GMT-0500 (Eastern Standard Time)
| Pass | WCAG Success Criterion | Notes |
| --- | --- | --- |
| ❌ | [2.1.1 Keyboard](https://www.w3.org/WAI/WCAG21/Understanding/keyboard.html) | COMUI-798 The popover content is only accessible on mouse hover. Keyboard users and screenreader users cannot access the content within the popover. |
...
| ❌ | [4.1.2: Name, Role, Value](https://www.w3.org/WAI/WCAG21/Understanding/name-role-value.html) | COMUI-798 Consider using tooltip role https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/tooltip_role |
