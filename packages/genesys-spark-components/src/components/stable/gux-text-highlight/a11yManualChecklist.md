...
| ❌ | [4.1.2: Name, Role, Value](https://www.w3.org/WAI/WCAG21/Understanding/name-role-value.html) | COMUI-816 highlighted text within the 'mark' tag is not always conveyed to screenreaders |
