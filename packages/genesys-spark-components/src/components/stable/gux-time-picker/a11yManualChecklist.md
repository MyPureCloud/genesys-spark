...
**Last Updated:** 2025-01-13T12:06:00.322Z
...
| ❌ | [3.3.1 Error Identification](https://www.w3.org/WAI/WCAG22/Understanding/error-identification.html) | Error is not provided to user without gux-form-field-time-picker |
| ❌ | [3.2.2 Labels or Instructions](https://www.w3.org/WAI/WCAG22/Understanding/labels-or-instructions.html) | [COMUI-3410](https://inindca.atlassian.net/browse/COMUI-3410) No indication provided of step in input |
