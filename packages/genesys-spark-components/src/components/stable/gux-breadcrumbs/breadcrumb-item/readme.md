...
| `--gse-ui-breadcrumbs-primary-separator-padding`                 |             |
| `--gse-ui-breadcrumbs-primary-separator-typography-fontFamily`   |             |
| `--gse-ui-breadcrumbs-primary-separator-typography-fontSize`     |             |
...
| `--gse-ui-breadcrumbs-secondary-separator-padding`               |             |
| `--gse-ui-breadcrumbs-secondary-separator-typography-fontFamily` |             |
| `--gse-ui-breadcrumbs-secondary-separator-typography-fontSize`   |             |
