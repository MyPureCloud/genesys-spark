...
| -------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------ |
| `characterLimit`     | `character-limit`      | The characterLimit property defines the max character limit for the input.                                                                                                                                                                                                      | `number`                                | `100`        |
...
| `showCharacterCount` | `show-character-count` | The showCharacterCount property will display a charcter counter at the top right corner of the form-field indicating how many characters have been typed into the input.                                                                                                        | `boolean`                               | `false`      |
