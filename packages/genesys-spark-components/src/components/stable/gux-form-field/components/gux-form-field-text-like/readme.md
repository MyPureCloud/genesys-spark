...
| -------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------ |
| `characterLimit`     | `character-limit`      | The characterLimit property defines the max character limit for the input.                                                                                                                                                                                                      | `string`                                | `"100"`      |
...
| `showCharacterCount` | `show-character-count` | The showCharacterCount property will display a label at the top right corner of the form-field indicating how many characters have been typed into the input.                                                                                                                   | `boolean`                               | `false`      |
