# gux-table-toolbar manual accessibility testing status

**Last Updated:** 2025-01-08T11:36:45.149Z
| Pass | WCAG Success Criterion | Notes |
| --- | --- | --- |
| ✅ | [1.1.1 Non-text Content](https://www.w3.org/WAI/WCAG22/Understanding/non-text-content.html) | - |
| ❌ | [2.1.1 Keyboard](https://www.w3.org/WAI/WCAG22/Understanding/keyboard.html) | [COMUI-3378](https://inindca.atlassian.net/browse/COMUI-3378) - Cannot access the additional actions menu via keyboard. |
| ✅ | [2.1.2 No Keyboard Trap](https://www.w3.org/WAI/WCAG22/Understanding/no-keyboard-trap.html) | - |
| ❌ | [2.4.3 Focus Order](https://www.w3.org/WAI/WCAG22/Understanding/focus-order.html) | [COMUI-3378](https://inindca.atlassian.net/browse/COMUI-3378) - Left and right arrow keys should be used for navigation |
