...
describe('gux-rating', () => {
  ...
  describe('#render', () => {
    [
      ...
      '<gux-rating increment="half" value="0" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="0.5" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="1" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="1.5" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="2" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="2.5" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="3" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="3.5" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="4" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="4.5" aria-label="Feedback"></gux-rating>',
      '<gux-rating increment="half" value="5" aria-label="Feedback"></gux-rating>',
