# gux-pagination-legacy manual accessibility testing status

**Last Updated:** Thu Dec 16 2021 10:57:46 GMT-0500 (Eastern Standard Time)
...
| ❌ | [2.5.3 Label in Name](https://www.w3.org/WAI/WCAG21/Understanding/label-in-name.html#dfn-name) | COMUI-803 additional accessible context should be added to some of the elements |
