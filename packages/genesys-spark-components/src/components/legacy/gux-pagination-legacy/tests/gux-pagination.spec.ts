...
import { GuxPaginationButtonsLegacy } from '../gux-pagination-buttons/gux-pagination-buttons';
import { GuxPaginationItemCountsLegacy } from '../gux-pagination-item-counts/gux-pagination-item-counts';
import { GuxPaginationItemsPerPageLegacy } from '../gux-pagination-items-per-page/gux-pagination-items-per-page';
