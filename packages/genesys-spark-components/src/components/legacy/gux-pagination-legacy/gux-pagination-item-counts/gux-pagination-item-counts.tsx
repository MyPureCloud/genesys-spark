...
@Component({
  styleUrl: 'gux-pagination-item-counts-legacy.scss',
  tag: 'gux-pagination-item-counts-legacy'
})
export class GuxPaginationItemCountsLegacy implements ComponentInterface {
  @Element()
