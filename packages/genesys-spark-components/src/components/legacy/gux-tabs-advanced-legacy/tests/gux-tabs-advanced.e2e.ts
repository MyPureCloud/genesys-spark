...
describe('gux-tabs-advanced-legacy', () => {
  ...
  <gux-tabs-advanced-legacy>
    ...
    >
      ...
      <gux-tab-advanced-legacy tab-id="1-4">
        Tab Header 4
      </gux-tab-advanced-legacy>
      <gux-tab-advanced-legacy tab-id="1-5">
        Tab Header 5 long long
      </gux-tab-advanced-legacy>
      <gux-tab-advanced-legacy tab-id="1-6">
        <gux-icon icon-name="user-directory" decorative="true"></gux-icon>
        Tab Header 6
        <gux-list slot="dropdown-options">
          <gux-list-item>
      ...
      <gux-tab-advanced-legacy tab-id="1-7">
        <gux-icon icon-name="user-directory" decorative="true"></gux-icon>
      ...
      <gux-tab-advanced-legacy tab-id="1-8">
      ...
      <gux-tab-advanced-legacy gux-disabled tab-id="1-9">
    ...
    <gux-tab-advanced-panel-legacy tab-id="1-4">
      <span>Tab content 4</span>
    </gux-tab-advanced-panel-legacy>
    <gux-tab-advanced-panel-legacy tab-id="1-5">
      <span>Tab content 5</span>
    </gux-tab-advanced-panel-legacy>
    <gux-tab-advanced-panel-legacy tab-id="1-6">
      <span>Tab content 6</span>
    </gux-tab-advanced-panel-legacy>
    <gux-tab-advanced-panel-legacy tab-id="1-7">
      <span>Tab content 7</span>
    </gux-tab-advanced-panel-legacy>
    <gux-tab-advanced-panel-legacy tab-id="1-8">
      <span>Tab content 8</span>
    </gux-tab-advanced-panel-legacy>
    <gux-tab-advanced-panel-legacy tab-id="1-9">
...
`;
  ...
  describe('#render', () => {
    ...
    it('renders', async () => {
      ...
      const element = await page.find('gux-tabs-advanced-legacy');
  ...
  describe('#interactions', () => {
    it('should change tabpanel content when tab is changed', async () => {
      ...
      const tabTarget = await page.find(
        'gux-tab-advanced-legacy[tab-id="1-2"]'
      );
    ...
    it('should not change tabpanel content when tab is disabled', async () => {
      const page = await newNonrandomE2EPage({ html: htmlExample1 });
      const tabTarget = await page.find(
        'gux-tab-advanced-legacy[tab-id="1-3"]'
      );
      const tabPanel = await page.find(
        'gux-tab-advanced-panel-legacy[tab-id="1-3"]'
      );
    ...
    it('should open and close options popup on click', async () => {
      ...
      const optionPopoverTarget = await page.find(
        'gux-tab-advanced-legacy[tab-id="1-1"] .gux-tab-options-button'
      );
      ...
      const optionPopover = await page.find(
        'gux-tab-advanced-legacy[tab-id="1-1"] gux-popover-list'
      );
