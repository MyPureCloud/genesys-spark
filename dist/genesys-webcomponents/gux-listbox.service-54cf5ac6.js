...
function getFirstSelectedOption(list) {
  return getListItems(list).find(option => option.selected && !option.disabled && !option.filtered);
}
...
export { setLastOptionActive as a, setFirstOptionActive as b, clearActiveOptions as c, setPreviousOptionActive as d, hasNextOption as e, setNextOptionActive as f, getSearchOption as g, hasPreviousOption as h, actOnActiveOption as i, goToOption as j, matchOption as m, onClickedOption as o, setInitialActiveOption as s };
